...
​
 ttendance 
′
 )−>nullable();table->time('proposed_closing_time')->nullable();
t
a
b
l
...
​
 reak1 
′
 )−>nullable();table->time('proposed_return_break1')->nullable();
t
a
b
l
...
​
 reak2 
′
 )−>nullable();table->time('proposed_return_break2')->nullable();
