...
//勤怠詳細画面関連
    ...
    public function showDetails(Request $request, $id)
    {
        ...
        $isAttendanceFinalized = ($attendance->status === 'approved' || (bool) $latestApprovedApplication);
        ...
        $data = compact(
            'attendance',
            'isPendingApproval',
            'isAttendanceFinalized',// 勤怠が確定済みかどうかのフラグ
            'isAdminLoggedIn',
            'pendingApplication',  // 承認待ちのApplicationモデルインスタンスを渡す
            'latestApprovedApplication',  // 最新の承認済みApplicationモデルインスタンス
