...
//勤怠一覧画面関連
    ...
    \Log::info('Raw Break Minutes for attendance ID ' . $attendance->id . ': ' . $rawBreakMinutes); // 生の休憩時間を確認

    $attendance->total_break_minutes = $this->convertMinutesToHhMm($rawBreakMinutes);
    \Log::info('Formatted Break Minutes for attendance ID ' . $attendance->id . ': ' . $attendance->total_break_minutes); // 変換後の休憩時間を確認
