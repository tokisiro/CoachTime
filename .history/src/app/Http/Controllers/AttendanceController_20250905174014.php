...
//勤怠詳細画面関連
    ...
    //スタッ月毎
    public function showStaffAttendance(Request $request, $id, $year = null, $month = null)
    {
        // ユーザーが存在するか確認
        $staff = User::find($id);
        if (!$staff) {
        ...
        // 該当スタッフの、指定された月の勤怠データを取得
        // 休憩時間もロードするために 'breaks' リレーションをwithで指定
