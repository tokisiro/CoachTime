...
//勤怠詳細画面関連
    ...
    public function showDetails(Request $request, $id)
    {
        ...
        if ($pendingApplication) {
            ...
            // 新しい休憩のみを抽出（idがない、または既存のidに含まれないもの）
            ...
            })->values()->toArray(); // インデックスを振り直す
        } else {
            $pendingApplication = (object)['new_proposed_breaks' => []]; // null の場合もこのプロパティを持つようにする
        }
        ...
        if ($latestApprovedApplication) {
            ...
            $latestApprovedApplication = (object)['new_proposed_breaks' => []]; // null の場合もこのプロパティを持つようにする
        }
