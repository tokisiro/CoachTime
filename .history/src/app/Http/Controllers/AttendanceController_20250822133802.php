...
//勤怠一覧画面関連
    ...
    public function showAttendanceList(Request $request){
        ...
        $attendances->map(function ($attendance) {
            $attendance->total_break_minutes = $this->convertMinutesToHhMm($attendance->getTotalBreakMinutesAttribute());
            ...
            if ($checkIn && $closing) {
                ...
                $attendance->formatted_working_minutes = $this->convertMinutesToHhMm($workingMinutes);
            } else {
                $attendance->formatted_working_minutes = '-';
            }
