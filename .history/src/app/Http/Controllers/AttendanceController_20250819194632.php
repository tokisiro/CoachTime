...
//勤怠一覧画面関連
    ...
    public function showAttendanceList(Request $request){
        ...
        $attendances = Attendance::where('user_id', $userId)->whereYear('date', $selectedMonth->year)->whereMonth('date', $selectedMonth->month)->orderBy('date', 'asc')
            ->with(['user', 'breaks']) // userとbreaksリレーションをロード
            ->get();
