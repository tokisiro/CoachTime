...
//勤怠詳細画面関連
    ...
    public function showDetails(Request $request, $id)
    {
        ...
        if ($isAdminLoggedIn) {
            ...
            return view('share.admin_attendance_details', compact('attendance', 'isPendingApproval', 'isAdminLoggedIn'));
        } else {
            // 一般ユーザーとしてログインしている場合は、一般ユーザー用の詳細ビューを返す
            return view('share.user_attendance_details', compact('attendance', 'isPendingApproval', 'isAdminLoggedIn'));
        }
