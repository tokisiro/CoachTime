...
class DetailsRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            // 既存の休憩時間の終了時間に関するメッセージ
            // 休憩終了時間が休憩開始時間より前、または退勤時間より後になっている場合
            // ここで、退勤時間より後になっている場合とそれ以外のメッセージを分ける
            'breaks.*.end_time.break_end_time_valid' => '休憩時間もしくは退勤時間が不適切な値です', // 一旦汎用的に
            'new_breaks.*.end_time.break_end_time_valid' => '休憩時間もしくは退勤時間が不適切な値です', // 一旦汎用的に
