...
class AppServiceProvider extends ServiceProvider
{
    ...
    Validator::extend('break_start_time_valid', function ($attribute, $value, $parameters, $validator) {
        ...
        dd([
            'attribute' => $attribute,
            'value' => $value, // 18:00
            'closingTimeFromData' => $closingTime, // 17:00
            'checkInTimeFromData' => $checkInTime, // 09:00
            'endTimeFromData' => $endTime, // 19:00 (今回の場合)
            'parsedClosing' => $closingTime ? Carbon::parse($closingTime)->toDateTimeString() : null,
            'parsedBreakStartTime' => $value ? Carbon::parse($value)->toDateTimeString() : null,
        ]);
