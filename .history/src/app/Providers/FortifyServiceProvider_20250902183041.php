...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        //dd('Fortify redirects called!', ['user_id' => $user->id ?? 'N/A', // $userがnullでないことを確認'user_role' => $user->role ?? 'N/A','current_guard_name' => Auth::guard()->getName(), // 認証されたガードの名前'request_is_admin_path' => $request->is('admin/*'),'intended_url' => $request->session()->pull('url.intended'),]);
