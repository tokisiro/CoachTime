...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->instance('fortify-login-pipeline', [
            CustomLoginPipeline::class, // あなたのカスタムパイプラインのみを配置
            // 他にFortifyが提供するログイン後（認証済み）のミドルウェアがあればここに追加できますが、
            // まずは認証部分のみに集中するため、これだけにします。
        ]);
