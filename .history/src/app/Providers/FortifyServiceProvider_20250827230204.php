...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Fortify::validateUsing(LoginRequest::class, function (Request $request) {

            $loginRequest = new LoginRequest(); // LoginRequestのインスタンスを作成
            // rules() と messages() を使ってバリデーションルールとメッセージを取得
