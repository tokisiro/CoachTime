...
class DetailsCorrectionFunctionTest extends TestCase
{
    ...
    public function it_creates_an_application_and_is_visible_to_admin()
    {
        ...
        $this->assertDatabaseHas('breaks', [
            'attendance_id' => $this->attendance->id,
            'start_time' => Carbon::parse($newBreakStartTime)->toDateTimeString(),
            'end_time' => Carbon::parse($newBreakEndTime)->toDateTimeString(),
        ]);
        ...
        //管理者ユーザーで申請一覧画面を確認する
        $adminApplicationsListPage = $this->get(route('admin.attendances.list')); // 仮のルート名
