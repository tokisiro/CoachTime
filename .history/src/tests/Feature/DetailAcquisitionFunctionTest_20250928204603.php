...
class DetailAcquisitionFunctionTest extends TestCase
{
    ...
    public function testGoToTheDetailsScreen()
    {
        ...
        $break2 = Break::factory()->create([
            'attendance_id' => $attendance->id,
            'start_time' => Carbon::parse($attendance->closing_time)->subHours(2)->toDateTimeString(), // 15:00
            'end_time' => Carbon::parse($attendance->closing_time)->subHours(1)->toDateTimeString(),   // 16:00 (1時間休憩)
        ]);
