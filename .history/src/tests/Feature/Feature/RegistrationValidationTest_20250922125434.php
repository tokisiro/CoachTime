...
class RegistrationValidationTest extends TestCase
{
    ...
    public function The_data_is_saved_successfully(): void
    {
        $userData = [
            'name' => 'Test User',
            'email' => 'test@example.com',
        ...
        // 'password' はハッシュ化されるため直接比較はできない
        // 'name' と 'email' が一致するレコードが存在することを確認
        ...
        //ユーザーが認証状態になること
        $this->assertAuthenticated();// ログイン済みであることを確認
    }
}
