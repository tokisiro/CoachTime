...
class UserInformationAcquisitionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->first1Break = \App\Models\Breaks::factory()->create([
            ...
            'end_time' =>  Carbon::parse('2025-10-01 14:00'),
        ]);
    ...
    public function admin_can_view_a_users_attendance_list()
    {
        ...
        $response = $this->get(route('admin.attendances.staff.list', ['user' => $this->test1Attendance->user_id,'year' => Carbon::parse($this->attendance1->date)->year, // attendance1のdateを使用
            'month' => Carbon::parse($this->attendance1->date)->month,]));
