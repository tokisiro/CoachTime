...
class AdminAttendanceListTest extends TestCase
{
    ...
    public function admin_can_navigate_to_previous_day_attendance()
    {
        ...
        // 昨日の勤怠データを作成
        $user1 = User::factory()->create(['name' => '前日ユーザー', 'role' => 'admin']);
        Attendance::factory()->create([
            'user_id' => $user1->id,
            'date' => $yesterday,
        ...
        $user2 = User::factory()->create(['name' => '今日ユーザー', 'role' => 'admin']);
        Attendance::factory()->create([
            'user_id' => $user2->id,
            'date' => $today,
            'check_in_time' => '09:00:00',
        ...
        $response = $this->actingAs($this->adminUser,'admin')->get(route('admin.attendance.list', ['date' => $yesterday->format('Y-m-d')]));
