...
class UserInformationAcquisitionTest extends TestCase
{
    ...
    public function admin_can_view_all_general_users_names_and_emails()
    {
        ...
        $response->assertSee($this->employeeUser２->name);
    ...
    public function admin_can_view_a_users_attendance_list()
    {
        ...
        $response = $this->get(route('admin.attendances.staff.list', ['user' => $this->test1Attendance->user_id,    'year' => Carbon::parse($this->test1Attendance->date)->year,
            'month' => Carbon::parse($this->test1Attendance->date)->month,]));
