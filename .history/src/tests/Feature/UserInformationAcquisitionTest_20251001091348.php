...
class UserInformationAcquisitionTest extends TestCase
{
    ...
    public function admin_can_view_a_users_attendance_list()
    {
        ...
        $response = $this->get(route('admin.attendances.staff.list', ['user' => $this->employeeUser1->user_id,    'year' => Carbon::parse($this->attendanceRecord1->date)->year,
        ...
        $response->assertSee(Carbon::parse($this->->check_in_time)->format('H:i'));
