...
class UserInformationAcquisitionTest extends TestCase
{
    ...
    protected $adminUser;
    protected $attendance1;  // generalUser1の勤怠を保持するプロパティを追加
    protected $attendance2;  // generalUser2の勤怠を保持するプロパティを追加
    protected $firstBreak1;  // attendance1の最初の休憩
    protected $firstBreak2;
