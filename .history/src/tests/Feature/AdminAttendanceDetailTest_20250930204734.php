...
class AdminAttendanceDetailTest extends TestCase
{
    ...
    public function error_message_is_displayed_if_check_in_time_is_after_closing_time()
    {
        ...
        $response = $this->actingAs($this->adminUser, 'admin')->put(route('admin.showDetails', ['id' => $this->testAttendance->id]), $invalidData);

        // リダイレクトされることを確認
        $response->assertSessionHasErrors(['check_in_time', 'closing_time']);
