...
<div class="attendance-register">
    <div class="attendance-register__situation">
        ...
        <div class="attendance-register__situation-date" id="date">
        </div>
...
<script>
    function showDateTime() {
      ...
      // HTMLに表示
        document.getElementByClassName('.attendance-register__situation-date').textContent = dateStr;
        document.getElementByClassName('.attendance-register__situation-time').textContent = timeStr;
    }
