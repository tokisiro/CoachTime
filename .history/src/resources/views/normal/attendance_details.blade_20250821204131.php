...
<div class="attendance-details">
    <form class="attendance-details__parts" action="" method="POST">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                <th>出勤・退勤</th>
                <td><input class="attendance-details__parts-table-- type="text" name="check_in_time" value="{{ $attendance->check_in_time ? \Carbon\Carbon::parse($attendance->check_in_time)->format('H:i') : '' }}"></td>
            ...
            <tr>
                ...
                <td class="attendance-details__parts-table--td">〜</td>
                <td><input type="text" name="break_end_time_1" value="{{ $attendance->breaks->get(0) && $attendance->breaks->get(0)->end_time ? \Carbon\Carbon::parse($attendance->breaks->get(0)->end_time)->format('H:i') : '' }}"></td>
            </tr>
            <tr>
                <th>休憩２</th>
                <td><input type="text" name="break_start_time_2" value="{{ $attendance->breaks->get(1) && $attendance->breaks->get(1)->start_time ? \Carbon\Carbon::parse($attendance->breaks->get(1)->start_time)->format('H:i') : '' }}"></td>
                <td class="attendance-details__parts-table--td">〜</td>
                <td><input type="text" name="break_end_time_2" value="{{ $attendance->breaks->get(1) && $attendance->breaks->get(1)->end_time ? \Carbon\Carbon::parse($attendance->breaks->get(1)->end_time)->format('H:i') : '' }}"></td>
            </tr>
            <tr>
                <th>備考</th>
                <td><input type="text" name="remarks" value="{{ $attendance->remarks ?? '' }}"></td>
            </tr>
        </table>
