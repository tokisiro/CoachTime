...
<div class="attendance-details">
    <form class="attendance-details__parts" action="{{route('applications', ['id' => $attendance->id]) }}" method="POST" id="attendance-form">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                <th>備考</th>
                <td colspan="2"><textarea class="attendance-details__parts-table--remarks"  name="proposed_remarks" {{ $isPendingApproval || $isAttendanceFinalized ? 'disabled' : '' }}>{{ old('proposed_remarks', $defaultRemarks )}}</textarea>
                </td>
            </tr>
            @error('remarks')
            <tr>
