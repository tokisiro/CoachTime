...
<div class="attendance-details">
    <form class="attendance-details__parts" action="{{ route('attendance.apply_edit', ['id' => $attendance->id]) }}" method="POST">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                <th>休憩２</th>
                <td><input class="attendance-details__parts-table--input" type="text" name="breaks[{{ $attendance->breaks->count() }}][start_time]" value=""></td>
                <td class="attendance-details__parts-table--td">〜</td>
                <td><input class="attendance-details__parts-table--input" type="text" name="breaks[{{ $attendance->breaks->count() }}][end_time]" value=""></td>
            </tr>
            <tr>
                <th>備考</th>
                <td colspan="3"><input class="attendance-details__parts-table--remarks" type="textarea" name="remarks" value="{{ $attendance->remarks ?? '' }}"></td>
            </tr>
        </table>
