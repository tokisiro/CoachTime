...
<div class="attendance-details">
    <form class="attendance-details__parts" action="" method="POST">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                <th>日付</th>
                <td class="attendance-details__parts-table--name">{{ \Carbon\Carbon::parse($attendance->date)->isoFormat('YYYY年') }}</td>
                <td class="attendance-details__parts-table--td"></td>
                <td class="attendance-details__parts-table--name">{{ \Carbon\Carbon::parse($attendance->date)->isoFormat('M月DD日') }}</td>
            </tr>
            <tr>
                <th>出勤・退勤</th>
