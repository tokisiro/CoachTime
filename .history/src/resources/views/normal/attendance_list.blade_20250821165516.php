    ...
    <div class="attendance-list">
        ...
        <form action="{{ route('attendances.list') }}" method="GET" id="attendanceMonthForm" class="attendance-list__date">
            ...
            <div class="attendance-list__date-container">
                <div class="attendance-list__date-container--choice">
                    <img class="attendance-list__date-container--item" src="/images/calendar.png" alt="カレンダー" id="openMonthPicker">
                    <div id="displayMonth">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // openMonthPicker (imgタグ) がクリックされたら非表示のinput type="month" を開く
    if (openMonthPicker) { // 要素が存在するか確認
    ...
    if (actualMonthInput) { // 要素が存在するか確認
