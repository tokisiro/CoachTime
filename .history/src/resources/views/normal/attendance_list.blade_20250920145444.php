...
<div class="attendance-list">
    ...
    <div>
        ...
        <form action="{{ route('attendances.list') }}" method="GET" class="attendance-list__date" id="monthSelectionForm">
            ...
            <p>
                <button type="submit" class= "attendance-list__date-previous" data-month="{{ \Carbon\Carbon::parse($selectedMonth)->subMonth()->format('Y-m') }}" name="month">
                    <-前月
                </button>
            </p>
            ...
            <p>
                <button type="button" name="month" data-month="{{ \Carbon\Carbon::parse($selectedMonth)->addMonth()->format('Y-m') }}"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hiddenMonthInput = document.getElementById('hiddenMonthInput'); // 新しく追加した hidden input
