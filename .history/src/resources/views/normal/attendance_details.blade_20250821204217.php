    ...
    <form class="attendance-details__parts" action="" method="POST">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                ...
                <td class="attendance-details__parts-table--td">〜</td>
                <td><inputclass="attendance-details__parts-table--input" type="text" name="break_end_time_2" value="{{ $attendance->breaks->get(1) && $attendance->breaks->get(1)->end_time ? \Carbon\Carbon::parse($attendance->breaks->get(1)->end_time)->format('H:i') : '' }}"></td>
            </tr>
            <tr>
                <th>備考</th>
