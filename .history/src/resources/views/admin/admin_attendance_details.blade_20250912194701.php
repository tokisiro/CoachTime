    ...
    <form class="attendance-details__parts" action="{{ route('admin.approve', ['id' => $attendance->id]) }}" method="POST" id="attendance-form">
        ...
        <table class="attendance-details__parts-table">
            ...
            <tr class="attendance-details__parts-table--new" style="{{ $isPendingApproval ? 'display: none;' : '' }}">
                ...
                value="{{$isPendingApproval
                   ? (isset($pendingApplication->proposed_check_in_time) && $pendingApplication->proposed_check_in_time
                       ? \Carbon\Carbon::parse($pendingApplication->proposed_check_in_time)->format('H:i')
                       : ''
                     )
                   : (isset($latestApprovedApplication->proposed_check_in_time) && $latestApprovedApplication->proposed_check_in_time
