        ...
        <table class="attendance-details__parts-table">
            ...
            <tr class="attendance-details__parts-table--existing">
                ...
                <td>
                    ...
                    value="{{ old('breaks[{{ $index }}][start_time]',$break->start_time ? \Carbon\Carbon::parse($break->start_time)->format('H:i') : ($break->proposed_start_time ? \Carbon\Carbon::parse($break->proposed_start_time)->format('H:i') : '') )}}" {{ $isPendingApproval || $isAttendanceFinalized ? 'readonly' : '' }}>
                </td>
                    <td class="attendance-details__parts-table--td">〜</td>
                <td>
