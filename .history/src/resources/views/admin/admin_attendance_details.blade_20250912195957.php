        ...
        <table class="attendance-details__parts-table">
            ...
            <tr>
                ...
                value="{{ $isPendingApproval
                    ...
                    : ($latestApprovedApplication->proposed_check_in_time ? \Carbon\Carbon::parse($latestApprovedApplication->proposed_check_in_time)?->format('H:i') : '') }}" {{ $isPendingApproval || $isAttendanceFinalized ? 'disabled' : '' }}></td>
                <td class="attendance-details__parts-table--td">〜</td>
                ...
                value="{{ $isPendingApproval
                    ...
                    : ($latestApprovedApplication->proposed_closing_time ? \Carbon\Carbon::parse($latestApprovedApplication->proposed_closing_time)?->format('H:i') : '') }}" {{ $isPendingApproval || $isAttendanceFinalized ? 'disabled' : '' }}></td>
            </tr>
            @error('check_in_time')
            <tr>
                <th>ERROR</th>
