...
<div class="attendance-list">
    ...
    <form id="monthSelectionForm" action="{{ route('admin.attendances.staff.list', ['users' => $staff->id]) }}" method="GET" class="attendance-list__date">

        <a href="{{ $prevMonthUrl }}" class="attendance-list__date-nav">
            <-前月
        </a>
        <input type="month" name="month_selector" value="{{ $currentMonthValue }}">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    href="{{ route('admin.showDetails', ['id' => $attendance->id]) }}">詳細</a>
                </td>
            </tr>
            @empty
            <tr>
    ...
    <div class="attendance-list__download">
        <a href="{{ route('admin.attendance.exportCsv', ['id' => $staff->id, 'year' => $year, 'month' => $month]) }}" class="attendance-list__download-csv">
            CSV出力
        </a>
    </div>
</div>
