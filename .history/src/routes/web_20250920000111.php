...
Route::middleware('auth:web')->group(function () {
    ...
    //申請一覧画面
    Route::get('/http://localhost/login',[AttendanceController::class, 'showApplicationsList'])->name('showApplicationsList');
});
...
Route::middleware(['auth:web,admin'])->group(function () {
    // 勤怠詳細画面表示(管理)(一般)
    Route::get('/attendance/detail/{id}', [AttendanceController::class, 'showDetails'])->name('attendance.showDetails');
