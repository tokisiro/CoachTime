...
//勤怠詳細画面関連
    ...
    // 勤怠詳細表示
    Route::get('/attendance/{id}', [AttendanceController::class, 'showDetails'])->name('attendance.show')->middleware('auth');

    // 勤怠修正申請送信
    Route::post('/attendance/{id}/apply-edit', [AttendanceController::class, 'applications'])->name('attendance.apply_edit');

//申請一覧画面関連(一般)(管理)

    //申請一覧(管理)(一般)
    Route::get('/stamp_correction_request/list',function () {
    return view('share.application_list');
    });
